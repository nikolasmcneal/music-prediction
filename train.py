...
gating_mode = 'mul'
input_size = (128, 48) # Was 128 x 44
...
#print('Model: prednet-{}-{}-peep{}-tbias{}-nt{}'.format(loss_mode, nt, peephole, lstm_tied_bias)) 
...
torch.save(model.state_dict(), 'models/prednet-27-8-regular-saved-data.pt'.format(loss_mode, nt, peephole, lstm_tied_bias))
